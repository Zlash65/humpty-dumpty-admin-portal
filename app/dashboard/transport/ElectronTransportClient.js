...
function normalizeTransportColumnsModel(model) {
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const model = normalizeTransportColumnsModel(saved?.columnVisibilityModel);
...
function TransportDialog({ mode, open, onClose, branchId, initial, onDone }) {
